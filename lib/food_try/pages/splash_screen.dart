...
import 'package:food_delivary/food_try/model/splash_model.dart';
                ...
                ElevatedButton(
                  onPressed: () {
                    if((pageController.page??0)>0){
                      pageController.animateToPage((pageController.page?.toInt()??0)-1, duration: Duration(seconds: 1), curve: Curves.easeIn);
                    }
                  },
                  child: Text(
                    "Previous",
